// Expo mocks for Jest (runs after React Native setup).
'use strict';
...
if (typeof globalThis.__REACT_DEVTOOLS_GLOBAL_HOOK__ === 'undefined') {
  // RN 0.74 looks for this; tests need a stub so nothing crashes
...
// dev experience URL for asset resolution in tests
...
// UIManager can be missing in RN 0.81+ so check before defineProperty
